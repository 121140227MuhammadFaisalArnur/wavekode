...
export default function PortfolioDetail({ data }) {
  ...
  return (
    <section className="container mx-auto">
      <Fade bottom>
        <Button type="link" href="/project" className="flex w-40 h-8 text-lg items-center ml-6 sm:ml-20 mt-8 font-light text-t-palate hover:underline">
          <svg className="w-5 h-5 text-t-palate mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        data.map((item) => (
          <div className="flex flex-col mt-8 justify-center">
            <Fade bottom triggerOnce>
              ...
              <p className="font-light text-xl text-t-palate text-center mb-10">
                {item.type}
              </p>
            </Fade>
            ...
            <Fade bottom delay={300 * 1} triggerOnce>
              <div className="flex flex-col mt-16 mb-12 mx-8 sm:mx-16 xl:mx-28">
                ...
                <p className="font-light text-lg text-t-palate text-justify">
                ...
                <div className="flex flex-row ml-1">
                  {
                    item.responsibility.map((responsibility) => (
                      <div className="mr-4 px-6 py-3 text-theme-o-blue border border-theme-o-blue rounded-full shadow-lg">
                        {responsibility}
                      </div>
                    ))
                  }
              ...
              <p className="font-light italic text-t-palate mt-16 mx-8 sm:mx-16 xl:mx-28">
                * This project is just example.
                {' '}
                <br />
                Original project :
                {' '}
                <Button type="link" href={item.credit} target="_blank" className="text-theme-o-blue" isExternal>{item.credit}</Button>
              </p>
            </Fade>
          </div>
        ))
