...
export default function Service({ data }) {
  return (
    <div className="bg-gradient-to-r from-primary2 to-primary">
      <div className="container mx-auto pt-20 pb-28">
        ...
        <Fade direction="left" triggerOnce>
          <p className="font-light text-lg text-t-palate text-center mb-12">
            We are prepared to help grow your business with our exceptional service.
          </p>
        </Fade>
        ...
        <div className="grid grid-rows-3 px-10 gap-8 sm:grid-cols-3 sm:grid-rows-1 sm:gap-6 xl:gap-16">
          {
            data.map((item, index) => (
              ...
              <Fade direction={item.animation} delay={500 * index} key={index} triggerOnce>
                <div>
                  <div className="bg-gradient-to-b from-primary2 to-primary group rounded-2xl shadow-2xl border border-light-theme-purple transform transition duration-500 hover:scale-105">
