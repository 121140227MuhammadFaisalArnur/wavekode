        ...
        <Tabs className="flex flex-col px-4">
          <TabList>
            <div className="flex flex-row mb-5">
              <Tab>
                <button className="font-normal px-5 py-2 mr-3 text-theme-o-blue text-lg border border-theme-o-blue rounded-full transition duration-300 hover:bg-theme-o-blue hover:text-white focus:outline-none focus:bg-theme-o-blue focus:text-white">Mobile</button>
              </Tab>
              <Tab>
                <button className="font-normal px-5 py-2 mr-3 text-theme-o-blue text-lg border border-theme-o-blue rounded-full transition duration-300 hover:bg-theme-o-blue hover:text-white focus:outline-none focus:bg-theme-o-blue focus:text-white">Website</button>
              </Tab>
              <Tab>
                <button className="font-normal px-8 py-2 text-theme-o-blue text-lg border border-theme-o-blue rounded-full transition duration-300 hover:bg-theme-o-blue hover:text-white focus:outline-none focus:bg-theme-o-blue focus:text-white">UI/UX</button>
              </Tab>
            </div>
          </TabList>
                    ...
                    <Button type="link" href={`/project/${item.id}`}>
                      <div className="group rounded-2xl shadow-xl w-auto m-3 transform transition duration-500 hover:scale-110 portofolio-card">
                        ...
                        <div className="py-4">
                          ...
                          <p className="font-light text-t-palate text-center">{item.type}</p>
                        </div>
                      </div>
                    </Button>
                  </Fade>
