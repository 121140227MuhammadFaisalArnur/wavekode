  ...
  return (
    <section className="container mx-auto">
      ...
      <Fade direction="up" delay={500}>
        <p className="font-light text-lg text-t-palate text-center mb-3 sm:mb-3 xl:mb-4">
            ...
            <div className="flex-col xl:w-full rounded-2xl shadow-xl sm:shadow-2xl border px-8 py-6 mx-2 mb-6 mt-6 xl:mx-auto sm:mx-6 sm:mb-12">
              <div className="flex items-center mb-5">
                ...
                <div className="flex-col pl-5">
                  ...
                  <p className="font-light text-t-palate">{item.company}</p>
                </div>
              </div>
              <p className="font-light text-2xl text-t-palate pl-5 pt-3 pb-1">
                {item.testimoni}
              </p>
            </div>
          </SwiperSlide>
